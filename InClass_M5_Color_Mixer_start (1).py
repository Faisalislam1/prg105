...
def check_colors(one, two):
	...
	# the only other choice is yellow

	# the only other choice for the first color is yellow
	# the only other choice is blue
...
def main():
	...
	print(f"{first_color} and {second_color} make {result_color}")
